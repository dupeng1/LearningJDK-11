...
public abstract class FileSystemProvider {
     ...
     */
    // 返回指定实体的目录流，用来搜寻目录内的【直接子项】（需要自定义过滤器）
     ...
     */
    /*
     * 创建/打开一个文件，并返回其关联的【异步文件通道】，工作线程在这个过程中会被启动并阻塞
     *
     * path    : 文件路径
     * options : 文件操作属性
     * executor: 工作线程的线程池
     ...
     */
    // 创建文件/目录的【符号链接】；在windows上相当于"mklink link target"(文件的符号链接)或"mklink /D link target"(目录的符号链接)
