 ...
 *
 * @apiNote It is recommended to obtain a {@code Path} via the {@code Path.of} methods
...
public final class Paths {
     ...
     * @implSpec This method simply invokes {@link Path#of(URI) * Path.of(URI)} with the given parameter.
     * @see Path#of(URI)
     */
