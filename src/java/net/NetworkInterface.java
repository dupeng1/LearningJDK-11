 ...
 * @since 1.4
 */
// NetworkInterface表示一个【网络接口】，这可以是一个【物理的网络接口】，也可以是一个【虚拟的网络接口】
public final class NetworkInterface {
    ...
    // 返回一个更友好的名字，类似于“Ethernet Card 0”
    // 在UNIX上测试，它总是返回与getName同样的结果
    // 在windows上，可以看到稍微友好一些的名字，如“Local Area Connection”
    ...
    // 一个网络接口可以绑定多个IP地址，现在这种情况不太常见，但确实存在
