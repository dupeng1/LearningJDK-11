 ...
 */
/**
 * 表示一个【基于IP的Socket地址】【(ip + port)】，用于【TCP/UDP连接】
 * 通常会用一个主机和一个端口（对于客户端）或者只使用一个端口（对于服务器）来创建InetSocketAddress
 */
public class InetSocketAddress extends SocketAddress {
     ...
     */
    // 使用【通配IP】和【指定的端口号】初始化Socket地址；【端口为0时随机分配端口】
     ...
     *                                  range of valid port values.
     */
    // 使用【指定的IP地址】和【指定的port】构造一个Socket地址；如果IP地址为null，使用通配地址；如果端口号为0，则使用随机端口
     ...
     * @see #isUnresolved()
     */
    // 使用【指定的主机名称/地址】和【指定的port】初始化Socket地址；端口为0时随机分配端口
