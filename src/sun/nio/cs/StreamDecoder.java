...
public class StreamDecoder extends Reader {
    ...
    private CharsetDecoder decoder; // 【字节解码器】。【字节进来，字符出去】，完成对【字节序列的解码操作】
    ...
    private int read0() throws IOException {
        synchronized(lock) {
            ...
            // 尝试从字符输入流中读取2个char，并将其填充到cbuf[0]处。返回实际填充的字符数量，这里多读取了一个字符，下次读取可以直接读取
            int n = read(cb, 0, 2);
    ...
    // 从输入源【读取字节】，将其【解码为字符】后填充到字符数组cbuf中[off, end)处，返回实际填充的字符数
